...
parser.add_argument('--data_source', type=str, default='SD2', help='Suffix of test data') #SD2
...
parser.add_argument('--data_type', type=str, default="test", help='Generated data type (test)')
...
parser.add_argument('--seed_test', type=int, default=2026, help='Seed for testing heuristics')
# args for tricks
...
parser.add_argument('--pair_input_dim', type=int, default=8, help='Dimension of operation-machine raw feature vectors')
...
parser.add_argument('--init_embed_dim', type=float, default=128, help='initial embedding dimension')
...
parser.add_argument('--bit_dim', type=int, default=7, help='multi-hot vector dimension (d_z)')

# args for PGMPO Algorithm
parser.add_argument('--num_envs', type=int, default=128, help='C=2^(bit_dim)')
parser.add_argument('--num_problems', type=int, default=16, help='Batch size (B) for training environments')
parser.add_argument('--accmulation_step', type=int, default=2, help='gradient accmulation_step')
parser.add_argument('--max_updates', type=int, default=8000, help='Epochs (E) * accmulation_step')
...
parser.add_argument('--save_timestep', type=int, default=10, help='Interval for model saving')
